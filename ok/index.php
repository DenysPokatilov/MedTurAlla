...
$maillogin="kazantip4ik87@gmail.com"; // Логин smtp +++

$mailpass="Sydak2009"; // Пароль smtp +++

$senderdomain="mail.ru"; // Домен отправителя +++

$sendermail="ru@saitos.ru"; // Адрес отправителя +++

$replymail=$_POST["email"]; // Адрес для ответа

$recepname="Вы"; // Имя получателя

$recepmail="moiadres@mail.ru"; // Куда отправлять заявки (наш email-адрес) +++
